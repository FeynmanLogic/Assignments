...
for i in range(0,len(to_encrypt)-1,2):
    ...
    print(pos2)
    if pos1[0]==pos2[0]:
        npos1=[pos1[0],(pos1[1]+1)%6]
        npos2=[pos2[0],(pos2[1]+1)%6]
    elif pos1[1]==pos2[1]:
        npos1=[(pos1[0]+1)%6,pos1[1]]
        npos2=[(pos2[0]+1)%6,pos2[1]]
    else:
        temp=pos1
        npos1=[pos2[0],pos1[1]]
        npos2=[temp[0],pos2[1]]
...
for i in range(0,len(encrypted),2):
    ...
    print(pos2)
    if pos1[0]==pos2[0]:
        nnpos1=[pos1[0],(pos1[1]-1)%6]
        nnpos2=[pos2[0],(pos2[1]-1)%6]
    elif pos1[1]==pos2[1]:
        nnpos1=[(pos1[0]-1)%6,pos1[1]]
        nnpos2=[(pos2[0]-1)%6,pos2[1]]
    else:
        temp=pos1
        temp2=pos2
